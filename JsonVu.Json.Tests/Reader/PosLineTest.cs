    ...
    public class PosLineTest {
        ...
        public void ポジションとライン() {
            ...
            var expects = new ReaderExpect[] { 
                ...
                new ReaderExpect(){Token = JsonToken.PropertyName,  Type=ValueType.String, Quote=QuoteType.Double, Pos = 6, Line = 2, Value = "FOO" },
                new ReaderExpect(){Token = JsonToken.Value, Type = ValueType.Number, Value = "1234", Pos = 13, Line = 2},
                new ReaderExpect(){Token = JsonToken.PropertyName,  Type=ValueType.String, Quote=QuoteType.Double, Pos = 18, Line = 2, Value = "BAR" },
