    ...
    public class PosLineTest {
        ...
        public void ポジションとライン() {
            ...
            var expects = new Expect[] { 
                ...
                new Expect(){Token = JsonToken.PropertyName,  Type=ValueType.String, Quote=QuoteType.Double, Pos = 6, Line = 2, Value = "FOO" },
                new Expect(){Token = JsonToken.Value, Type = ValueType.Number, Value = "1234", Pos = 13, Line = 2},
                new Expect(){Token = JsonToken.PropertyName,  Type=ValueType.String, Quote=QuoteType.Double, Pos = 18, Line = 2, Value = "BAR" },
